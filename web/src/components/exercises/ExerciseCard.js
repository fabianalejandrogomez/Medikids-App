        ...
        return (
            <div style={styles.container}>
                <Card zDepth={2} style={styles.card}>
                    ...
                    >
                        <MenuItem primaryText="Duplicar" onClick={this.handleDuplicateClick} leftIcon={<ContentContentCopy/>}/>
                        <MenuItem primaryText="Borrar" onClick={this.handleDeleteClick} leftIcon={<ActionDelete/>}/>
                        <Divider/>
                        <MenuItem primaryText="Progreso" onClick={this.handleProgressClick} leftIcon={<ActionTrendingUp/>}/>
                        <MenuItem primaryText="Historia" onClick={this.handleHistoryClick} leftIcon={<ActionHistory/>}/>
                    </IconMenu>
                    <CardText>
                        <List>
                ...
                >
                    <div>
                        <p>Estas seguro que queres borrar una Medicion?'{this.props.exercise.name}'?</p>
