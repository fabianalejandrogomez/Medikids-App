                    ...
                    <CardText style={styles.text}>
                        <List>
                            ...
                            <TextField
                                style={styles.field}
                                hintText={'Comienzo'}
                                floatingLabelText={'Comienzo'}
                                errorText={exercise.startTime && !Number.isFinite(getUnixTimestamp(exercise.startTime)) ? "No es una fecha valida." : ''}
                            ...
                            <TextField
                                ...
                                floatingLabelText={'Finalizacion'}
                                errorText={exercise.endTime && !Number.isFinite(getUnixTimestamp(exercise.endTime)) ? "No es una fecha valida." : ''}
