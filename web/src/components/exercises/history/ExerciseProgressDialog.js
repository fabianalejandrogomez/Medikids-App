    ...
    fetchHistory = (filters) => {
        this.setState({ 
            ...
            .then(response => {
                ...
                this.props.showSnackbar('Error mostrando historial de mediciones: ' + error);
        ...
        return (
            <div>
                <Dialog
                    ...
                    title={this.props.exercise.name + ' Progreso'} 
                    autoScrollBodyContent={true}
                    actions={
                        <div>
                            <FlatButton 
                                label="Ver Progreso Completo" 
                        ...
                        <Line 
                            ...
                            options={{ 
                                ...
                                tooltips: {
                                    ...
                                    callbacks: {
                                        footer: (tooltipItems, data) => exercises[tooltipItems[0].index] && exercises[tooltipItems[0].index].notes ? 'Notas: ' + exercises[tooltipItems[0].index].notes : undefined,
                                    },
                                }, 
                            }}
                        />
