    ...
    componentWillMount() {
        ...
        this.setState({ loadApi: { isExecuting: true }}, () => {
            ...
            .then(response => {
                ...
                this.props.showSnackbar('Error en Mediciones: ' + error);
    ...
    fetchHistory = (filters, api = 'refreshApi') => {
        this.setState({ 
            ...
            .then(response => {
                ...
                this.props.showSnackbar('Error actualizando informacion de Eventos: ' + error);
    ...
    render() {
        ...
        workouts = workouts.map(w => { 
            ...
            return { 
                ...
                status: w.startTime === undefined ? 'Agendado' : w.endTime === undefined ? 'started' : 'completed',
                color: color,
