            ...
            <div>
                <Card zDepth={2} style={!this.state.api.isExecuting ? styles.card : { ...styles.card, backgroundColor: grey300 }}>
                    <CardHeader                        
                        ...
                        subtitle={
                            this.props.workout.startTime === undefined ? 'Agendado para el ' + moment(this.props.workout.scheduledTime).calendar() :
                            'Comenzado ' + moment(this.props.workout.startTime).calendar()
                        }
                    ...
                    <CardText>
                        <div style={styles.content}>
                            ...
                            <TextField
                                ...
                                floatingLabelText={'Notas del Evento'}
                ...
                >
                    <p>Estas seguro que queres finalizar el Evento: '{this.props.workout.routine.name}'?</p>
                    <p>Una vez finalizado no puede recomenzarse.</p>
                </ConfirmDialog>
                <ConfirmDialog 
                    title={'Borrar Evento'}
                ...
                >
                    Estas seguro que queres borrar un Evento? '{this.props.workout.routine.name}'?
                </ConfirmDialog>
                <ConfirmDialog 
                    title={'Resetear Evento'}
                    buttonCaption={'Resetear'}
                    onConfirm={this.props.onReset}
                    onClose={this.handleResetDialogClose}
                    open={this.state.resetDialog.open} 
                >
                    <p>Estas seguro que queres resetear el Evento '{this.props.workout.routine.name}'?</p>
                    <p>No se guardaran los datos cargados!</p>
                </ConfirmDialog>
