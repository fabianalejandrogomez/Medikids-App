            ...
            <div>
                <Card zDepth={2} style={!this.state.api.isExecuting ? styles.card : { ...styles.card, backgroundColor: grey300 }}>
                    <CardHeader                        
                        ...
                        title={'Editando: ' + this.props.workout.routine.name}
                        subtitle={
                            'Completada ' + moment(this.props.workout.endTime).calendar()
                        }
                    ...
                    >
                        {this.state.editsMade ? <MenuItem primaryText="Cancel Edits" onClick={this.handleCancelEditClick} leftIcon={<NavigationCancel/>}/> :
                            <MenuItem primaryText="Volver al Reporte" onClick={this.handleCancelEditClick} leftIcon={<NavigationArrowBack/>}/>}
                    ...
                    <CardText>
                        ...
                        <TextField
                            ...
                            errorText={!Number.isFinite(getUnixTimestamp(workout.startTime)) ? "Esta no es un fecha valida." : ''}
                        ...
                        <TextField
                            ...
                            errorText={!Number.isFinite(getUnixTimestamp(workout.endTime)) ? "Esta no es una fecha valida." : ''}
                ...
                <ConfirmDialog 
                    title={'Borrar Historia de Eventos'}
