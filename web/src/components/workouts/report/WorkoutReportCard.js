        ...
        return (
            <div>
                <Card zDepth={2} style={ styles.card }>
                    ...
                    >
                        <MenuItem primaryText="Editar" onClick={this.handleEditClick} leftIcon={<ContentCreate/>}/>
                ...
                <ConfirmDialog 
                    title={'Borrar historial de Eventos'}
                    buttonCaption={'Borrar'}
                    onConfirm={this.props.onDelete}
                    onClose={this.handleDeleteDialogClose}
                    open={this.state.deleteDialog.open} 
                >
                    Estas seguro que quieres borrar el Estudio '{this.props.workout.routine.name}'?
                </ConfirmDialog>
            </div>
        );
    }
